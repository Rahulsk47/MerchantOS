...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        style={{ y, opacity }}
        className="container-cinematic relative z-10"
      >
          ...
          <div>
            ...
            <Reveal delay={0.2}>
              <p className="mt-6 text-base sm:text-lg text-ink-300 leading-relaxed max-w-xl">
                MerchantOS helps businesses grow revenue,
                become understandable to AI agents, and safely
                serve autonomous buyers.
              </p>
            </Reveal>
            ...
            <Reveal delay={0.4}>
              <p className="mt-6 text-xs text-ink-500 max-w-md">
                AI proposes. Policy decides. The merchant
          ...
          >
            <div className="flex flex-col items-center gap-1.5">
              <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-ink-850/90 border border-ink-700/60 backdrop-blur-sm flex items-center justify-center shadow-card group hover:border-electric-500/40 transition-colors">
                <Icon
                  className={`w-5 h-5 ${node.tone}`}
                />
              </div>

              <span className="text-2xs text-ink-400 whitespace-nowrap font-medium hidden sm:block">
                {node.label}
              </span>
            </div>
