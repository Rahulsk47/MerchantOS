...
import { ArrowRight, ArrowLeft, Check, Store, Package, Target, ShieldCheck, Sparkles, Upload, Link2, Plus, TrendingUp, Zap, Bot } from 'lucide-react';
...
export default function OnboardingPage() {
  ...
  const { updateMerchant, pushToast } = useApp();
  ...
  const next = () => {
    ...
    if (step === 4) {
      updateMerchant({
        businessName: business.name || 'Northwind Commerce',
        industry: business.industry || 'Electronics & Accessories',
        storeUrl: business.url || 'northwind.example.com',
