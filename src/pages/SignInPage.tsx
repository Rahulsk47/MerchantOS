    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex flex-1 relative bg-ink-900 items-center justify-center p-12 overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="mt-4 text-ink-400">
            Manage AI agent traffic, OpenTabs, policies, and the Trust Ledger — all in one place.
          </p>
          <div className="mt-8 space-y-3">
            {['AI proposes. Policy decides.', 'Every transaction audited.', 'The merchant always remains in control.'].map((t) => (
              <div key={t} className="flex items-center gap-2.5 text-sm text-ink-300">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm">
          ...
          <p className="mt-2 text-sm text-ink-400">Enter your credentials to access your workspace.</p>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-4">
            ...
            <div className="flex items-center justify-between text-xs">
              <label className="flex items-center gap-2 text-ink-400 cursor-pointer">
                <input type="checkbox" className="rounded border-ink-600 bg-ink-800" /> Remember me
              </label>
              <a href="#" className="text-electric-400 hover:text-electric-300">Forgot password?</a>
            </div>
          ...
          <p className="mt-6 text-center text-sm text-ink-400">
            ...
            <Link to="/onboarding" className="text-electric-400 hover:text-electric-300 font-medium">Start building</Link>
          </p>
          <div className="mt-6 flex items-center justify-center">
            <Link to="/" className="text-xs text-ink-500 hover:text-ink-300 flex items-center gap-1.5">
